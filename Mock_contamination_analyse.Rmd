...
# Normalizes counts to percentages and adds study label
...
# Filter Mock samples on theoretical genus
# inhouse_mock_2022
...
# view genus in mock community
# Genus_abundance_all_mock_studies = 
#   all_mock_studies %>% 
#   group_by(Sample, Genus, Source_mock) %>%
#   summarize(total_abundance = sum(Abundance))
# view(Genus_abundance_all_mock_studies)

```

```{r view genera in the mock, eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
# Summarizes and joins measured vs theoretical abundances
...
all_studies_list =
  list(mock_only_inhouse_2022_BKIS_proj1_Q16705, mock_only_inhouse_2023_BKIS_proj1_Q16705,
       ...
       mock_only_OSOJ_proj4_Q17230, mock_only_OSOJ_proj5_Q17229, mock_only_SHSU_proj1_Q17228, 
       mock_only_YLUO_projx_Q12374, mock_only_YXIN_proj1_Q16712, mock_only_PRJEB34118, mock_only_PRJNA862376, 
       mock_only_KJOH_proj04_Q17535, mock_only_KJOH_proj05_Q17536, mock_only_KJOH_proj06_Q17537) %>% 
  bind_rows()
```
...
all_studies_plot_median_abund =
  ...
  labs(y="Percentage Sample ASV in mock community", x = "Percentage abundance")

ggsave("figures/all_studies_plot_median_abund.pdf", plot = all_studies_plot_median_abund, width = 9, height = 5)
ggsave("figures/all_studies_plot_median_abund.jpg", plot = all_studies_plot_median_abund, width = 9, height = 5)

all_studies_plot_median_abund


# plot prevalaence 
all_studies_plot_max_mean_median_abund =
  all_studies_list %>% 
...
ggsave("figures/all_studies_plot_max_mean_median_abund.pdf", plot = all_studies_plot_max_mean_median_abund, width = 9, height = 5)
ggsave("figures/all_studies_plot_max_mean_median_abund.jpg", plot = all_studies_plot_max_mean_median_abund, width = 9, height = 5)

all_studies_plot_max_mean_median_abund

# plot prevalaence; prevalence
all_studies_plot_prevalence =
  ...
  stat_smooth(aes(group = study, color = study), method = "lm", se = T) +
  facet_wrap(~sample_char, nrow = 2, ncol = 4, scales = "free") +
  labs(y="Percentage Sample ASV in mock community (Log10)", x = "Prevalence")

ggsave("figures/all_studies_plot_prevalence.pdf", plot = all_studies_plot_prevalence, width = 9, height = 5)
ggsave("figures/all_studies_plot_prevalence.jpg", plot = all_studies_plot_prevalence, width = 9, height = 5)
...
emmeans::emtrends(statistic_all_studies_2, pairwise ~ study, var = "value")
...
# calculate trend (contamination slope)
...
# calculate differences and ratio DNA concentration
abund_dna_char = 
...
```{r statstiek contaminat slope, eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
# p value dna ratio
